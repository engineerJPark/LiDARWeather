...
class STFDataset(Det3DDataset):
    ...
    Args:
        ...
        All_classes:
        ['DontCare' 'LargeVehicle' 'LargeVehicle_is_group' 'Obstacle'
        'PassengerCar' 'PassengerCar_is_group' 'Pedestrian' 'Pedestrian_is_group'
        'RidableVehicle' 'RidableVehicle_is_group' 'Vehicle' 'Vehicle_is_group'
        'person' 'train'] 이게 왜 내 결과

        ['Car' 'Cyclist' 'DontCare' 'Pedestrian' 'Van'] Hahner의 결과

        ['Car', 'Pedestrian', 'Cyclist'] 원하는 것
    """
    # TODO: use full classes of kitti
    METAINFO = {
        'classes': ('Pedestrian', 'Cyclist', 'Car', 'Van', 'DontCare'),
