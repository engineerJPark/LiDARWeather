...
for cor in cor_list:
    for sev in sev_list:
        cor_list4path.append(f'{cor}/{sev}')
...
def create_nuscenes_infos(root_path,
    ...
    Args:
        ...
        max_sweeps (int, optional): Max number of sweeps.
            Default: 10.
    """
    for cor in cor_list4path:
        root_path_ = osp.join(root_path, 'nuScenes-C', cor) if cor != 'clean' else root_path
        ...
        if test:
            ...
            info_val_path = osp.join(root_path_,
