...
pkl_file = '/data/nuScenes/nuscenes_infos_train.pkl'
...
with open('/data/nuScenes/nuscenes_1pct.txt', 'r') as f:
    tokens_1 = f.read().splitlines()

with open('/data/nuScenes/nuscenes_10pct.txt', 'r') as f:
    tokens_10 = f.read().splitlines()

with open('/data/nuScenes/nuscenes_20pct.txt', 'r') as f:
    tokens_20 = f.read().splitlines()

with open('/data/nuScenes/nuscenes_50pct.txt', 'r') as f:
