...
def parse_args():
    ...
    parser.add_argument(
        '--save_predict', action='store_true', help='save_prediction')
...
def main():
    ...
    if args.save_predict:
        cfg['model']['test_cfg'] = dict(save_predict=True, work_dir=cfg.work_dir,
        ...
        if 'segmentor_teacher' in cfg['model']:
            cfg['model']['segmentor_teacher']['test_cfg'] = cfg['model']['test_cfg']
            cfg['model']['segmentor_student']['test_cfg'] = cfg['model']['test_cfg']
